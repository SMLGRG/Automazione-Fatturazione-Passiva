...
#   ]
# }}
# Se non riesci a estrarre un campo, usa N/D o 0 per i numeri.
...
# - total_amount è SEMPRE il valore dopo "Totale EUR" o simili in fondo al blocco, mai le singole voci (005, 065, B23, 113)
...
# - weight_kg è il numero dopo "Lordi" nel blocco spedizione indica il peso in kg potrebbe variare di posizione a seconda del formato della fattura, ma è sempre associato alla spedizione
...
# {markdown}"""
# PROMPT_GENERICO = """Sei un estrattore dati deterministico. Il tuo compito è analizzare il testo di una fattura di trasporti ed estrarre le singole spedizioni in un JSON pulito.

# REGOLE TASSATIVE PER I NUMERI:
# 1. Trova il valore dopo la parola "TOTALE:" o "TOTALE: ... EUR" di OGNI singola spedizione. Rimuovi i punti delle migliaia e usa il punto come decimale.
# 2. Trova il peso espresso dopo "KG" o nella colonna "P. L.". Deve essere un numero float puro (es. se leggi 1.119,00 deve diventare 1119.0; se leggi 6.809,30 deve diventare 6809.3). Non dividere per mille.

# REGOLE PER GLI INDIRIZZI:
# - Cerca la riga del destinatario (es. SOCIETE LEMAHIEU, BEKINTEX, RIETER, SAGAERT).
# - In 'recipient_name' scrivi SOLO il nome dell'azienda, senza indirizzi o codici.
# - In 'destination_city' estrai solo la città.
# - In 'destination_postal_code' estrai il CAP numerico.
# - In 'destination_country' metti la sigla della nazione di 2 lettere presente alla fine (FR, BE, DE, IT).
# - Il campo 'sender_name' è sempre "MARCHI & FILDI SPA" per tutte le spedizioni di questa fattura.

# Rispondi SOLO con il JSON avente questa esatta struttura, senza racchiuderlo in blocchi di codice markdown (NO ```json), senza preamboli e senza commenti:
# {{
#     "invoice_number": "Numero fattura",
#     "invoice_date": "Data fattura (YYYY-MM-DD)",
#     "carrier_name": "Eurotir",
#     "shipments": [
#         {{
#             "tracking_number": "Il numero di spedizione formato 01/23/50XXXX",
#             "shipment_date": "Data spedizione (YYYY-MM-DD)",
#             "sender_name": "MARCHI & FILDI SPA",
#             "recipient_name": "Nome pulito azienda destinataria",
#             "destination_city": "Città destinatario",
#             "destination_postal_code": "CAP destinatario",
#             "destination_country": "Nazione destinatario (2 lettere)",
#             "weight_kg": 0.0,
#             "service_type": "DAP",
#             "total_amount": 0.0
#         }}
...
# Testo della fattura da elaborare:
# {markdown}
# """
# ACTIVE_PROMPT = PROMPT_GENERICO
